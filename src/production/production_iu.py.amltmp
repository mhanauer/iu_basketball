...
l = st.number_input('Enter losses:', min_value=0.0, step=1, value = 12)
...
sos = st.number_input('Enter strength of schedule (sos):', min_value=0.0, step=1, value = 10)
...
ap_pre = st.number_input('Enter AP preseason ranking:', min_value=0.0, step=1, value = 15)
